...
func main() {
	// Объявление флагов для настройки сортировки.
	...
	// Чтение строк из файла и извлечение ключей.
	...
	// Проверка отсортированности данных, если флаг checkSorted установлен.
	...
	// Удаление дубликатов, если флаг unique установлен.
	if *unique {
		lines = removeDuplicates(lines)
	}

	// Определение выходного файла, если указан флаг outputFileName.
